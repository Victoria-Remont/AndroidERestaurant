...
import fr.isen.remont.androiderestaurant.databinding.ActivitySignupBinding
import org.json.JSONObject

interface SignUpActivityFragmentInteraction {
    fun showLogin()
    fun showRegister()
    fun makeRequest(email: String?, password: String?, lastname: String?, firstname: String?, isfromLogin: Boolean)
}

class UserActivity : AppCompatActivity(), SignUpActivityFragmentInteraction {
